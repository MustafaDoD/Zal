...
if query.startswith("الاوامر") and event.query.user_id == zedub.uid:
    buttons = [
        [Button.inline("❶", data="ahmed1"), Button.inline("❷", data="ahmed2"), Button.inline("❸", data="ahmed3"), Button.inline("❹", data="ahmed4")],
        [Button.inline("❺", data="ahmed5"), Button.inline("❻", data="ahmed6"), Button.inline("❼", data="ahmed7"), Button.inline("❽", data="ahmed8")],
        [Button.inline("❾", data="ahmed9"), Button.inline("❿", data="ahmad10"), Button.inline("⓫", data="ahmad12")],
        [Button.inline("⓬", data="ahmad13"), Button.inline("⓭", data="ahmad14"), Button.inline("⓮", data="ahmad15")],
        [Button.inline("⓯", data="ahmad16"), Button.inline("⓰", data="ahmad17")],
        [Button.inline("⓱", data="ahmad18"), Button.inline("⓲", data="ahmad19"), Button.inline("⓳", data="ahmadd20")]
    ]
